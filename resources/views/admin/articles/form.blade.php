...
<form class="editor-form" method="post" action="{{ $article->exists ? route('admin.articles.update', $article) : route('admin.articles.store') }}">
    ...
    <div class="editor-grid">
        ...
        <aside class="admin-form-card admin-editor-sidebar">
            ...
            @if(in_array(auth()->user()->role, ['super_admin', 'admin'], true))<label class="admin-switch"><input type="checkbox" name="is_editor_pick" value="1" @checked(old('is_editor_pick', $article->is_editor_pick))><span><b>Pilihan Editor</b><small>Berita terpenting; pilihan terbaru menjadi headline utama dan masuk kurasi redaksi.</small></span></label>@endif
