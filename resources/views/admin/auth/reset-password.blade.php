<x-admin-auth-shell title="Password Baru">
    ...
    <form method="post" action="{{ route('admin.password.update') }}" class="admin-auth-form">
        ...
        <div class="admin-auth-field"><x-icon name="lock" /><input id="password" name="password" type="password" minlength="12" autocomplete="new-password" required></div>
        <label for="password_confirmation">Konfirmasi password</label>
        <div class="admin-auth-field"><x-icon name="shield" /><input id="password_confirmation" name="password_confirmation" type="password" minlength="12" autocomplete="new-password" required></div>
