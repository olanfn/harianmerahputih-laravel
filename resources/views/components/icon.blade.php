...
<svg {{ $attributes->merge(['class' => 'ui-icon', 'width' => $size, 'height' => $size, 'viewBox' => '0 0 24 24', 'aria-hidden' => 'true']) }}>
    @switch($name)
        ...
        @case('phone')<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.8" d="M6.5 3.5 9 3l2 5-2.2 1.6a14 14 0 0 0 5.1 5.1l1.6-2.2 5 2-.5 2.5a3 3 0 0 1-3.2 2.4C10.2 18.8 5.2 13.8 4.1 6.7A3 3 0 0 1 6.5 3.5Z"/>@break
        @case('whatsapp')<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.8" d="M12 3a9 9 0 0 0-7.8 13.5L3 21l4.7-1.2A9 9 0 1 0 12 3Zm-3 4.5c.3-.3.7-.3 1-.1l1.1 1.7c.2.3.2.7-.1 1l-.5.5a7 7 0 0 0 2.9 2.9l.5-.5c.3-.3.7-.3 1-.1l1.7 1.1c.3.2.4.7.1 1-.5.7-1.2 1.1-2 1-3.7-.6-6.6-3.5-7.2-7.2-.1-.8.3-1.5 1-2Z"/>@break
        ...
        @case('eye')<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.8" d="M2.5 12s3.3-5.5 9.5-5.5 9.5 5.5 9.5 5.5-3.3 5.5-9.5 5.5S2.5 12 2.5 12Zm9.5 2.8a2.8 2.8 0 1 0 0-5.6 2.8 2.8 0 0 0 0 5.6Z"/>@break
        @case('eye-off')<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.8" d="m3 3 18 18M10.6 6.7A10.6 10.6 0 0 1 12 6.5c6.2 0 9.5 5.5 9.5 5.5a17 17 0 0 1-3.1 3.7M6.2 6.9C3.9 8.3 2.5 12 2.5 12s3.3 5.5 9.5 5.5c.9 0 1.7-.1 2.5-.4M9.2 9.2a2.8 2.8 0 0 0 3.9 3.9"/>@break
